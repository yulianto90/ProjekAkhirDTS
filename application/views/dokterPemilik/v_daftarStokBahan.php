                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    foreach($bahan as $u){ ?>
                                        ...
                                        <td>
                                        <a href="<?php echo base_url() . 'index.php/dokterPemilik/editStokBahan/' .$u->kode_bahan ; ?>">
                                            <button class="btn btn-warning btn-sm" data-toggle="tooltip" data-placement="bottom" title="Edit Stok Bahan"> 
                                                <i class="fa fa-edit"></i> 
                                            </button>
                                        </a>
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                        <?php
                                          echo anchor("/dokterPemilik/hapusStokBahan/" .$u->kode_bahan,'<button class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="bottom" title="Hapus Stok Bahan"><i class="fa fa-trash"></i></button></a>', array('class'=>'delete','onclick'=>'return confirmDialog();'));
                                        ?>
                                        </div>
                                        </td>
                                    </tr>
