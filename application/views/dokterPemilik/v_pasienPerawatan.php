    ...
    <div id="wrapper">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo base_url('index.php/dokterPemilik/daftarPasien'); ?>"><i class="fa fa-table fa-fw"></i> Pasien</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Profil Pasien Perawatan</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
    ...
    <div class="modal fade" id="modal_selesai<?php echo $u->no_pasien ?>" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url() . 'index.php/dokterPemilik/statusSelesai/' .$u->no_pasien ; ?>">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                ...
                                <div class="col-md-8">
                                    <textarea name="keterangan" class="form-control" type="text" placeholder="...." required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
