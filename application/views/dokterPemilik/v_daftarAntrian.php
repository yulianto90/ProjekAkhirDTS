        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                        ...
                        <li class="active">
                            <a class="active" href="<?php echo base_url('index.php/dokterPemilik'); ?>"><i class="fa fa-tasks fa-fw"></i> Antrian Pasien</a>
                        </li>
                        <li>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="panel panel-red">
                                            ...
                                            <div class="panel-footer">
                                                ...
                                                <div>
                                                    <a href="<?php echo base_url() . 'index.php/dokterPemilik/statusPerawatan/' .$u->no_pasien ; ?>" >
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="panel panel-yellow">
                                            ...
                                            <div class="panel-footer">
                                                <label>Dokter: <?php echo $u->username ?></label>
                                                <div>
                                                    <a href="<?php echo base_url() . 'index.php/dokterPemilik/pasienPerawatan/' .$u->no_pasien ; ?>">
