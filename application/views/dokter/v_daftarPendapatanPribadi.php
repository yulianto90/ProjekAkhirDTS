                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a class="active" href="<?php echo base_url('index.php/Dokter/daftarPendapatanPribadi'); ?>">Pendapatan Pibadi</a>
                                </li>
                                <li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="pull-left row col-lg-6">
                                <form action="<?php echo base_url('index.php/Dokter/daftarPendapatanPribadi');?>" method="get">
                                    <label>
