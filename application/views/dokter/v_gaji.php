...
<body>
    ...
    <div id="wrapper">
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a class="active" href="<?php echo base_url('index.php/Dokter/gaji'); ?>">Gaji</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"> Gaji Dokter</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="pull-left row col-lg-6">                            
                                <label>Bulan
                                    <select class="form-control" name="bulan1" id="bulan">
                                ...
                                <label>Tahun
                                    <select class="form-control" name="tahun1" id="tahun">
                                        <option value="0">Show All</option>
                                        <?php
                                        $thn_skr = date('Y');
    ...
    function dokter() {
        ...
        var tahun = $("#tahun").val();
        $.ajax({
            url : "<?= base_url('index.php/Dokter/showGajiDokter') ?>",
