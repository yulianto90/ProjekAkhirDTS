...
<body>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a class="active" href="<?php echo base_url('index.php/perawat/daftarPengeluaran'); ?>"> <i class="fa fa-edit fa-fw"></i> Pengeluaran Bahan</a>
                        </li>
                        <li>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="pull-left row col-lg-6">
                                <form action="<?php echo base_url('index.php/perawat/daftarPengeluaran');?>" method="get">
                                    <label>
                                ...
                                <?php 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                              echo anchor("/perawat/hapusPengeluaranBahan/" .$u->no_pengeluaran,'<button class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="bottom" title="Hapus Pengeluaran Bahan"><i class="fa fa-trash"></i></button></a>', array('class'=>'delete','onclick'=>'return confirmDialog();'));
                                            ?>
                                            </div>
                                        </td>
                                    </tr>    
    ...
    <div class="modal fade" id="modal_bahanLama" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/perawat/tambahPengeluaran'); ?>">
    ...
    <div class="modal fade" id="modal_bahanBaru" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/perawat/tambahStokBahan'); ?>">
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="col-md-2"></div>
                            <div class="col-md-8">
    ...
    function isi_otomatis() {
        ...
        $.ajax({
            url: "<?php echo base_url() ?>index.php/perawat/form_pengeluaran_autocomplit",
            type: "GET",
